  ...
  return (
    <main style={ui.page}>
      ...
      <p style={{ marginTop: 0, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        <Link href="/admin/magazine" style={{ ...ui.btn, textDecoration: 'none', display: 'inline-block' }}>📰 Gestisci il Magazine →</Link>
        <Link href="/admin/impostazioni" style={{ ...ui.btn, textDecoration: 'none', display: 'inline-block' }}>⚙️ Impostazioni (API) →</Link>
      </p>
